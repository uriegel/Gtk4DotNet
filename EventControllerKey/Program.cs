...
Action onActivate = () => 
{
    ...
    var eck = EventControllerKey.New();
    Gtk.SignalConnect<EventControllerKey.KeyPressedDelegate>(eck, "key-pressed", (_AppDomain, v, c, state, __) =>
    {
        return false;
    });
    Widget.AddController(window, eck);

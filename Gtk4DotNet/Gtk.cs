...
public static class Gtk
{
    ...
    public extern static long SignalConnect(this GtkHandle widget, string name, IntPtr callback, IntPtr n, IntPtr n2, int n3);

    [DllImport(Libs.LibGtk, EntryPoint="g_signal_connect_object", CallingConvention = CallingConvention.Cdecl)]
    public extern static long SignalConnect(this GtkHandle widget, string name, IntPtr callback, IntPtr obj, int n3);
    
    [DllImport(Libs.LibGtk, EntryPoint="g_signal_connect_data", CallingConvention = CallingConvention.Cdecl)]
    public extern static long SignalConnectAfter(this GtkHandle widget, string name, IntPtr callback, IntPtr n, IntPtr n2, int n3);

    [DllImport(Libs.LibGtk, EntryPoint="g_signal_handler_disconnect", CallingConvention = CallingConvention.Cdecl)]
    public extern static void SignalDisconnect(this GtkHandle widget, long id);
}

...
public static class MenuButton
{
    ...
    public static MenuButtonHandle Model(this MenuButtonHandle menuButton, MenuModelHandle menuModel)
    ...
    [DllImport(Libs.LibGtk, EntryPoint="gtk_menu_button_set_menu_model", CallingConvention = CallingConvention.Cdecl)]
     extern static void SetModel(this MenuButtonHandle menuButton, MenuModelHandle menuModel);
}

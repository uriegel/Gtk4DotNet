...
public static class EventControllerKey
{
    ...
    public static EventControllerKeyHandle OnKeyPressed(this EventControllerKeyHandle eventControllerKey, Func<char, int, KeyModifiers, bool> onKeyPressed)
    ...
    public static EventControllerKeyHandle OnKeyReleased(this EventControllerKeyHandle eventControllerKey, Action<char, int, KeyModifiers> onKeyReleased)

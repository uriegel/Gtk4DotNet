...
public class AdwDialog : Widget
{
    ...
    {
        get => GetCanClose(this);
        set => SetCanClose(this, value);
    }
    ...
    [DllImport(Libs.LibAdw, EntryPoint = "adw_dialog_get_can_close", CallingConvention = CallingConvention.Cdecl)]
    extern static bool GetCanClose(AdwDialog dialog);

    [DllImport(Libs.LibAdw, EntryPoint = "adw_dialog_set_can_close", CallingConvention = CallingConvention.Cdecl)]
    extern static void SetCanClose(AdwDialog dialog, bool val);
}

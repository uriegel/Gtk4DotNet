...
static class ChangingColumnViews
{
    ...
    // TODO Subclass Button and check addweakref
    // TODO addweakref for gtk_column_view_new
    ...
    public static int Run()
    {
        void InitStore(ApplicationHandle _)
        {
            ...
            itemNumberFactory = SignalListItemFactory
                ...
                .Setup(OnListItemSetup)
                .Bind(OnNumberBind);
            itemIDFactory = SignalListItemFactory
                .New()
                .Setup(OnListItemSetup)
                .Bind(OnIDBind);
            itemTextFactory = SignalListItemFactory
                .New()
                .Setup(OnListItemSetup)
                .Bind(OnTextBind);
    ...
    {
        modelItem2 = ListStore
            .New(GItem2.GType)
            .Splice([.. Enumerable.Range(1, 1000).Select(n => GItem2.New(new(n, $"Item {n}")).Handle)]);

        columnView
            .AppendColumn(ColumnViewColumn.New("ID", itemIDFactory!)
                .Expand()
                .Resizeable()
                .SetSorter(numberSorter))
            .AppendColumn(ColumnViewColumn.New("Name", itemNameFactory!)
    ...
    static ListModelHandle? modelItem2;
    ...
    static SignalListItemFactoryHandle? itemIDFactory;
    static SignalListItemFactoryHandle? itemTextFactory;
